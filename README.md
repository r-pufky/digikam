...
or an explicit digikam version (e.g. 7.8.0), which will provide updates but
...
|--------|-------------------------|-----------------------------------------------------------------|
| latest | digikam container 7.8.0 | [7.8.0 Release](https://download.kde.org/stable/digikam/7.8.0/) |
| stable | digikam container 7.8.0 | [7.8.0 Release](https://download.kde.org/stable/digikam/7.8.0/) |
